...
namespace {
	...
	class API extends \Teepluss\Api\Facades\API{
		/**
		 * Instance API.
		 *
		 ...
		 * @static 
		 */
		 public static function __construct($config, $router, $request, $remoteClient){
			//Method inherited from \Teepluss\Api\Api
			 \Teepluss\Api\Api::__construct($config, $router, $request, $remoteClient);
		 }
		 ...
		 */
		 public static function createResponse($messages, $code = 200){
			//Method inherited from \Teepluss\Api\Api
			return \Teepluss\Api\Api::createResponse($messages, $code);
		 }
		 ...
		 * @static 
		 */
		 public static function deviseResponse($messages, $code = 200){
			//Method inherited from \Teepluss\Api\Api
			return \Teepluss\Api\Api::deviseResponse($messages, $code);
		 }
		 ...
		 */
		 public static function make($data, $code, $overwrite = false){
			//Method inherited from \Teepluss\Api\Api
			return \Teepluss\Api\Api::make($data, $code, $overwrite);
		 }
		 ...
		 */
		 public static function getRemoteClient(){
			//Method inherited from \Teepluss\Api\Api
			return \Teepluss\Api\Api::getRemoteClient();
		 }
		 ...
		 * @static 
		 */
		 public static function invoke($uri, $method, $parameters = array()){
			//Method inherited from \Teepluss\Api\Api
			return \Teepluss\Api\Api::invoke($uri, $method, $parameters);
		 }
		 ...
		 * @static 
		 */
		 public static function invokeRemote($uri, $method, $parameters = array()){
			//Method inherited from \Teepluss\Api\Api
			return \Teepluss\Api\Api::invokeRemote($uri, $method, $parameters);
		 }
		 ...
		 */
		 public static function __call($method, $parameters = array()){
			//Method inherited from \Teepluss\Api\Api
			return \Teepluss\Api\Api::__call($method, $parameters);
		 }
